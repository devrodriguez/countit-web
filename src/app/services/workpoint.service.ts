...
import { Firestore, collectionData, collection, CollectionReference, DocumentData, addDoc, getDoc, doc, updateDoc, query, where, getDocs } from '@angular/fire/firestore';
